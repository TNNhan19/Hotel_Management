...
namespace QuanLyHotel_WindowProgramming
{
    public partial class MainForm_TiepTan : Form
    {
        ...
        {
            lblWelcome.Text = "Hi, " + UserSession.Username; // hoặc lấy tên từ DB nếu cần
        ...
        {
            FoodEditForm foodEditForm = new FoodEditForm(); // Tạo đối tượng form
        ...
        {
            FormShiftScheduler formShiftScheduler = new FormShiftScheduler(); // Tạo đối tượng form
            formShiftScheduler.ShowDialog();
        }
    }
}
